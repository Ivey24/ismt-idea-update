    ...
    <div class="side-bar p-sm-4 p-3">
        <div class="left-side border-bottom py-2">
            ...
            <ul>
                ...
                <li>
                    <a href="/category"> <span class="span">Category</span>
                    </a>
                </li>
                <li>
                    <a href="/product"> <span class="span">Product</span>
                    </a>
                </li>
                <li>
                    <a href="/customer"> <span class="span">Customer</span>
                    </a>
                </li>
                <li>
                    <a href="/order"> <span class="span">Order</span>
                    </a>
                </li>
